...
function screenStatus(){
	...
	if(config["curIdx"] == 0){
		$(".screen-0 .info,.screen-0 .advantage,.screen-0 .down-btn").addClass("fadeInUp");
		$(".screen-1 .left,.screen-1 .right").removeClass("sfadeInUp");
    $(".screen-1 .gongju,.screen-1 .tijian").removeClass("sfadeInUp");
    $(".screen-3 .info,.screen-3 .down-btn").removeClass("fadeInUp");
		go_to_top.hide();
	}
	if(config["curIdx"] == 1){
		$(".screen-0 .info,.screen-0 .advantage,.screen-0 .down-btn").removeClass("fadeInUp");
    ...
    $(".screen-2 .safe1").removeClass("sfadeInUp");
    $(".screen-3 .info,.screen-3 .down-btn").removeClass("fadeInUp");
		a = 570 + 330;
    ...
    $(".screen-2 .safe1").addClass("sfadeInUp");
    ...
    $(".screen-2 .safe1").removeClass("sfadeInUp");
		...
		// $(".screen-3 .left,.screen-3 .right").removeClass("sfadeInUp");
		// $(".screen-3 .tools-box").removeClass("sfadeInUp");
		$(".screen-3 .info,.screen-3 .down-btn").addClass("fadeInUp");
...
// 回到顶部
$("#go-to-top .up").on("click",function(){
	$.scrollTo('.screen-0',700,function(){
		slide_page_item.removeClass("trig-current").eq(0).addClass("trig-current");
		config["pageSlide"] = false;
		config["curIdx"] =0;
		screenStatus();
		go_to_top.hide();
...
//tab动画
// $(".nav-lists a").on("mouseenter",function(){
// 	$(".tabLine").stop();
// 	var i=$(this).index();var dis=["55px","142px","259px","377px","462px"];var wtd=["32px","63px","63px","32px","72px"]
// 	$(".tabLine").animate({"left": dis[i],"width":wtd[i]},'fast');
// })
// 宽窄屏适配
// function adapt(){
